                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="cid:logoId" alt="" title=""
                                         style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 59%;max-width: 342.2px;"
                                         width="342.2" />
                                  </td>
                                </tr>
                              </table>
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <table height="0px" align="center" border="0" cellpadding="0" cellspacing="0" width="19%"
                                style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;border-top: 5px solid #e56426;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                <tbody>
                                  <tr style="vertical-align: top">
                                    <td
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-font-size"
                                style="font-size: 14px; color: #616161; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="line-height: 140%; text-align: center;"><strong><span
                                      style="line-height: 19.6px;">${message}</span></strong></p>
                              </div>
                            </td>
                          </tr>
                        </tbody>
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-font-size"
                                style="font-size: 14px; color: #616161; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="line-height: 140%; text-align: center;">We request that you provide the most up-to-date and completed information for each of these clients</p>
                              </div>
                            </td>
                          </tr>
                        </tbody>
